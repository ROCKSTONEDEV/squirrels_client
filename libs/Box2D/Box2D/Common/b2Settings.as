...
public class b2Settings{
	...
	*/
	static public const b2_maxTranslation:Number = 20.0;
	...
	*/
	static public const b2_timeToSleep:Number = 0.1;					// half a second
	/**
	* A body cannot sleep if its linear velocity is above this tolerance.
	*/
	static public const b2_linearSleepTolerance:Number = 0.1;			// 1 cm/s
	/**
	* A body cannot sleep if its angular velocity is above this tolerance.
	*/
	static public const b2_angularSleepTolerance:Number = 1.0 / 180.0 * b2Settings.b2_pi;	// 2 degrees/s
