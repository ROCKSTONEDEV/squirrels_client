...
public class b2World
{
	...
	*/
	...
	public function DrawDebugData() : void{
		...
		var vs:Vector.<b2Vec2> = Vector.<b2Vec2>([new b2Vec2(), new b2Vec2(), new b2Vec2(), new b2Vec2()]);
		...
		if (flags & b2DebugDraw.e_aabbBit)
		{
			...
			vs = new Vector.<b2Vec2>([new b2Vec2(),new b2Vec2(),new b2Vec2(),new b2Vec2()]);
	...
	*/
	...
	b2internal function SolveTOI(step:b2TimeStep) : void{
		...
		for (;;)
		{
			...
			if (minContact.IsSensor()||
				!minContact.IsEnabled())
			{
				// Restore the sweeps
