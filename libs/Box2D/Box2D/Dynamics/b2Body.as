...
public class b2Body
{
	...
	*/
	...
	public function renewTransform():void
	{
		this.m_xf = new b2Transform(this.m_xf.position, this.m_xf.R);
	}
	...
	*/
	...
	{
		b2Settings.b2Assert(!m_world.IsLocked());
		if (m_world.IsLocked())
		{
			return;
		}
	...
	*/
	...
	public var extGravity:b2Vec2 = new b2Vec2();
