...
public class b2Island
{
	...
	public function Solve(step:b2TimeStep, gravity:b2Vec2, allowSleep:Boolean) : void
	{
		...
		for (i = 0; i < m_bodyCount; ++i)
		{
			...
			b.m_linearVelocity.x += step.dt * (gravity.x + b.extGravity.x + b.m_invMass * b.m_force.x);
			b.m_linearVelocity.y += step.dt * (gravity.y + b.extGravity.y + b.m_invMass * b.m_force.y);
