...
public class b2Fixture
{
	...
	b2internal function Synchronize(broadPhase:IBroadPhase, transform1:b2Transform, transform2:b2Transform):void
	{
		...
		aabb1.upperBound.x = 0.0;
		aabb1.upperBound.y = 0.0;
		aabb1.lowerBound.x = 0.0;
		aabb1.lowerBound.y = 0.0;

		aabb2.upperBound.x = 0.0;
		aabb2.upperBound.y = 0.0;
		aabb2.lowerBound.x = 0.0;
		aabb2.lowerBound.y = 0.0;
	...
	private var aabb1:b2AABB = new b2AABB();
	private var aabb2:b2AABB = new b2AABB();
