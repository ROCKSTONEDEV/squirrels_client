...
public class b2DistanceJoint extends b2Joint
{
	...
	b2internal override function InitVelocityConstraints(step:b2TimeStep) : void{
		...
		{
			var C:Number = length - (m_rope && m_length > length ? length : m_length);
	...
	b2internal override function SolvePositionConstraints(baumgarte:Number):Boolean
	{
		...
		var C:Number = length - (m_rope && m_length > length ? length : m_length);
		C = C < -b2Settings.b2_maxLinearCorrection ? -b2Settings.b2_maxLinearCorrection : C > b2Settings.b2_maxLinearCorrection ? b2Settings.b2_maxLinearCorrection : C;
		...
		return (C > 0.0 ? C : -C) < b2Settings.b2_linearSlop;
