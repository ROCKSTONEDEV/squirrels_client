...
public class b2PulleyJoint extends b2Joint
{
	...
	public function b2PulleyJoint(def:b2PulleyJointDef){
		...
		var b:Number = m_constant - m_ratio * b2_minPulleyLength;
		m_maxLength1 = def.maxLengthA < b ? def.maxLengthA : b;
		b = (m_constant - b2_minPulleyLength) / m_ratio;
		m_maxLength2 = def.maxLengthB < b ? def.maxLengthB : b;
	...
	b2internal override function SolveVelocityConstraints(step:b2TimeStep) : void 
	{
		...
		if (m_limitState1 == e_atUpperLimit)
		{
			...
			b = m_limitImpulse1 + impulse;
			m_limitImpulse1 = 0.0 > b ? 0.0 : b;
		...
		if (m_limitState2 == e_atUpperLimit)
		{
			...
			b = m_limitImpulse2 + impulse;
			m_limitImpulse2 = 0.0 > b ? 0.0 : b;
	...
	b2internal override function SolvePositionConstraints(baumgarte:Number):Boolean 
	{
		...
		if (m_state == e_atUpperLimit)
		{
			...
			a = C + b2Settings.b2_linearSlop;
			C = a < -b2Settings.b2_maxLinearCorrection ? -b2Settings.b2_maxLinearCorrection : a > 0.0 ? 0.0 : a;
