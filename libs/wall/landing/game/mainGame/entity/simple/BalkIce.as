package landing.game.mainGame.entity.simple
{
	...
	public class BalkIce extends GameBody implements IPinable
	{
		...
		static private const SHAPE:b2PolygonShape = b2PolygonShape.AsOrientedBox(50 / WallShadow.PIXELS_TO_METRE, 5 / WallShadow.PIXELS_TO_METRE, new b2Vec2());
		...
		static private const PINS:Array = [[-50 / WallShadow.PIXELS_TO_METRE, 0], [0, 0], [50 / WallShadow.PIXELS_TO_METRE, 0]];

		public function BalkIce():void
		{
			var view:DisplayObject = new IceBalk1();
			view.x = -50;
			view.y = -5;
			addChild(view);
		}
