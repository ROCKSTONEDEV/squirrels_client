package landing.game.mainGame.entity.editor
{
	...
	public class IslandLessSmall extends Island
	{
		static private const WIDTH:int = 36;
		...
		public function IslandLessSmall():void
		{
			super(WIDTH, HEIGHT, Island4, FIXTURE_DEF, SHAPE);
		}
	}
}