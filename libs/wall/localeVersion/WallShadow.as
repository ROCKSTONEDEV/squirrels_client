package
{
	...
	public class WallShadow extends MovieClip
	{
		...
		/*static public function addListenKeyBoard(name:String, listener:Function):void
		{
			_instance.owner.stage.addEventListener(name, listener);
		}*/

		public function WallShadow():void
		{
			_instance = this;
