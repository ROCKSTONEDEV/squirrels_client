package dragonBones.animation
{
	 ...
	 *
	 *			private var starlingFactory:NativeFactory;
	 *			private var armature:Armature;
	 *
	 *			public function DragonAnimation()
	 *			{
	 *				starlingFactory = new NativeFactory();
	 *				starlingFactory.addEventListener(Event.COMPLETE, handleParseData);
	 *				starlingFactory.parseData(new ResourcesData(), 'Dragon');
	 *			}
	 *
	 *			private function handleParseData(e:Event):void
	 *			{
	 *				armature = starlingFactory.buildArmature('Dragon');
