package dragonBones.factorys
{
	...
	public class BaseFactory extends EventDispatcher
	{
		 ...
		 * var starlingFactory:BaseFactory = new BaseFactory();
		 ...
		 * @example
		 * <listing>
		 * var data:SkeletonData = starlingFactory.getSkeletonData('dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * starlingFactory.addSkeletonData(data, 'dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * starlingFactory.removeSkeletonData('dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * var atlas:Object = starlingFactory.getTextureAtlas('dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * starlingFactory.addTextureAtlas(textureatlas, 'dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * starlingFactory.removeTextureAtlas('dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * var armature:Armature = starlingFactory.buildArmature('dragon');
		 * </listing>
		 ...
		 * @example
		 * <listing>
		 * var texturedisplay:Object = starlingFactory.getTextureDisplay('dragon');
		 * </listing>
