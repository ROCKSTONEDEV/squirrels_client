package views
{
	...
	public class ClothesImageLoader extends Sprite
	{
		...
		public function ClothesImageLoader(id:int, instant:Boolean = true, callback:Function = null):void
		{
			this.id = id;
		...
		public function load():void
		{
			...
			var cache:String = this.id in ClothesData.IMAGES_CACHE ? ClothesData.IMAGES_CACHE[this.id] : "";
			...
			this.urlLoader.load(new URLRequest(Config.IMAGES_URL + "clothes/accessories/ImageAccessories" + this.id + cache + ".png"));
		}
