package game.mainGame.entity.battle
{
	...
	public class BouncingPoise extends BattlePoise
	{
		...
		static private const SHAPE:b2CircleShape = new b2CircleShape(10 / Game.PIXELS_TO_METRE);
		static private const FIXTURE_DEF:b2FixtureDef = new b2FixtureDef(SHAPE, null, 0.8, 1, 0.3, CATEGORIES_BITS, MASK_BITS, 0);
		...
		public function BouncingPoise():void
		{
			this.view = new StarlingAdapterSprite(new BouncingPoiseImage());
			this.view.x = -15;
			this.view.y = -15;
