package game.mainGame.entity.editor
{
	...
	public class MountSliced extends Mount
	{
		...
		static private const DEFAULT_HEIGHT:Number = 217.55 / Game.PIXELS_TO_METRE;
		...
		public function MountSliced(view:DisplayObject=null, fixtureDef:b2FixtureDef = null, defaultWidth:Number = NaN, defaultHeight:Number = NaN):void
		{
