package game.mainGame.entity.editor
{
	...
	public class ShamanBody extends StarlingAdapterSprite implements IGameObject, ISerialize, IDispose, INetHidden, IEditorDebugDraw
	{
		protected var rotator:Rotator;

		public function ShamanBody():void
		{
			var view:StarlingAdapterSprite = new StarlingAdapterSprite(this.shamanIcon);
