package game.mainGame.entity.editor
{
	...
	public class Pyramid extends Mount
	{
		static private const DEFAULT_WIDTH:Number = 335 / Game.PIXELS_TO_METRE;
		static private const DEFAULT_HEIGHT:Number = 130 / Game.PIXELS_TO_METRE;
		static private const DEFAULT_SLICE:Number = 82 / Game.PIXELS_TO_METRE;
		static private const SLICE_RATIO:Number = DEFAULT_SLICE / DEFAULT_WIDTH;

		public function Pyramid(view:DisplayObject=null, fixtureDef:b2FixtureDef = null, defaultWidth:Number = NaN, defaultHeight:Number = NaN):void
		{
			view = view ? view : new PyramidView();
