package game.mainGame.entity.simple
{
	...
	public class BalkGlass extends CacheVolatileBody implements IPinable, ISensor, ILandSound
	{
		...
		public function BalkGlass():void
		{
			this.view = new StarlingAdapterSprite(new GlassBalkSmall());
			this.view.x = -50;
			this.view.y = -5;
		...
		public function postSolve(contact:b2Contact, impulse:b2ContactImpulse):void
		{
			...
			if (impulse.normalImpulses[0] < 150)
				return;
		...
		private function playAnimation(point:b2Vec2, gravity:b2Vec2, impulse:Number):void
		{
			...
			var chunk: StarlingAdapterSprite = StarlingConverter.splitMClipToSprite(new GlassBalkPieces);
