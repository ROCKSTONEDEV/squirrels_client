package game.mainGame.entity.simple
{
	...
	public class BalkIceLong extends SquareBody implements IPinable, ILandSound
	{
		...
		public function BalkIceLong():void
		{
			this.view = new StarlingAdapterSprite(new IceBalk2());
			this.view.x = -100;
			this.view.y = -5;
