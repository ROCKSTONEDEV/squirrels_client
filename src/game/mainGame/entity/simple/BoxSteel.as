package game.mainGame.entity.simple
{
	...
	public class BoxSteel extends SquareBody implements IPinable, ILandSound
	{
		...
		public function BoxSteel():void
		{
			this.view = new StarlingAdapterSprite(new SteelBoxView());
