package game.mainGame.entity.simple
{
	...
	public class BalkLongSteel extends SquareBody implements IPinable, ILandSound
	{
		...
		public function BalkLongSteel():void
		{
			this.view = new StarlingAdapterSprite(new SteelBalkLongView());
