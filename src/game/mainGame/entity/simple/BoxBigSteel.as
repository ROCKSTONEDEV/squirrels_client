package game.mainGame.entity.simple
{
	...
	public class BoxBigSteel extends SquareBody implements IPinable, ILandSound
	{
		...
		static private const SHAPE:b2PolygonShape = b2PolygonShape.AsOrientedBox(30 / Game.PIXELS_TO_METRE, 30 / Game.PIXELS_TO_METRE, new b2Vec2());
		...
		static private const PINS:Array = [[-30 / Game.PIXELS_TO_METRE, 0], [0, 0], [30 / Game.PIXELS_TO_METRE, 0]];

		public function BoxBigSteel():void
		{
			this.view = new StarlingAdapterSprite(new SteelBoxBigView());
