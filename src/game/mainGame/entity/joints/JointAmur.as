package game.mainGame.entity.joints
{
	...
	import game.mainGame.entity.view.AmurJointView;

	public class JointAmur extends JointToSquirrel
	{
		public var lifeTimeEnabled:Boolean = true;
		public var lifeTime:Number = 12;

		public function JointAmur():void
		{
			this.jointView = new AmurJointView();
