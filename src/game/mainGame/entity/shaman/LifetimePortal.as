package game.mainGame.entity.shaman
{
	...
	public class LifetimePortal extends Portal implements ILifeTime
	{
		private var _aging:Boolean = true;
		private var _lifeTime:Number = 0;
		private var disposed:Boolean = false;

		public function LifetimePortal(view: DisplayObjectContainer, arrow: DisplayObjectContainer, feather: DisplayObjectContainer = null):void
		{
			super(view, arrow, feather);
		}
