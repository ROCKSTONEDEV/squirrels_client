package game.mainGame.entity.magic
{
	...
	public class PirateBarrel extends SquareBody implements ILifeTime
	{
		...
		private var _lifeTime:Number = 20 * 1000;

		private var disposed:Boolean = false;

		public function PirateBarrel():void
		{
			this.view = new StarlingAdapterSprite(new PirateBarrelView());
			this.view.x = -21;
			this.view.y = -18;
