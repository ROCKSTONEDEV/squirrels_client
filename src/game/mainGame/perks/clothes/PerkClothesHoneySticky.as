package game.mainGame.perks.clothes
{
	...
	public class PerkClothesHoneySticky extends PerkClothesSelectPoint
	{
		public function PerkClothesHoneySticky(hero:Hero)
		{
			super(hero);
		...
		override protected function onPacket(packet:AbstractServerPacket):void
		{
			...
			switch (packet.packetId)
			{
				case PacketRoundSkill.PACKET_ID:
					...
					var castObject:StickyBomb = new StickyBomb();
