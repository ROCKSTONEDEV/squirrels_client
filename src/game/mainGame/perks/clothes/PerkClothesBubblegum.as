package game.mainGame.perks.clothes
{
	...
	public class PerkClothesBubblegum extends PerkClothesSelectPoint
	{
		public function PerkClothesBubblegum(hero:Hero)
		{
			super(hero);

			this.soundOnlyHimself = true;
			this.activateSound = "throw";
		}
		...
		override protected function onPacket(packet:AbstractServerPacket):void
		{
			...
			switch (packet.packetId)
			{
				case PacketRoundSkill.PACKET_ID:
					...
					var castObject:HarpoonBodyBubblegum = new HarpoonBodyBubblegum();
					...
					castObject.ropeShrinkFactor = 20;
