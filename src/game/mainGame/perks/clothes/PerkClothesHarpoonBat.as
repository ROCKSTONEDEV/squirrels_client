package game.mainGame.perks.clothes
{
	...
	public class PerkClothesHarpoonBat extends PerkClothesSelectPoint
	{
		public function PerkClothesHarpoonBat(hero:Hero):void
		{
			super(hero);
		...
		override protected function onPacket(packet:AbstractServerPacket):void
		{
			...
			switch (packet.packetId)
			{
				case PacketRoundSkill.PACKET_ID:
					...
					var castObject:HarpoonBodyBat = new HarpoonBodyBat();
