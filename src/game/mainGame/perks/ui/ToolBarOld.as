package game.mainGame.perks.ui
{
	...
	public class ToolBarOld extends Sprite
	{
		protected var buttonSprite:Sprite = new Sprite();
		protected var buttons:Vector.<ToolButtonOld> = new Vector.<ToolButtonOld>();

		public function ToolBarOld():void
		{
		...
		public function addButton(button:ToolButtonOld):void
		{
