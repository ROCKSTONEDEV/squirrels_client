...
{
	public class EffectOrcConfig
	{
		static public const BASE_CONFIG:String =
			'<particleEmitterConfig>' +
				'<sourcePosition x="0.00" y="0.00"/>' +
				'<sourcePositionVariance x="0" y="20.5"/>' +
				'<speed value="0"/>' +
				'<speedVariance value="0"/>' +
				'<particleLifeSpan value="0.43"/>' +
				'<particleLifespanVariance value="1.1400000000000001"/>' +
				'<angle value="178.12"/>' +
				...
				'<startColor red="0.42" green="1" blue="0.02" alpha="1"/>' +
				'<startColorVariance red="0" green="0" blue="0" alpha="0"/>' +
				'<finishColor red="0.18" green="0.81" blue="0.08" alpha="0.41000000000000003"/>' +
				'<finishColorVariance red="0.00" green="0.00" blue="0.00" alpha="0.00"/>' +
				'<maxParticles value="73.72"/>' +
				'<startParticleSize value="38.71"/>' +
				'<startParticleSizeVariance value="0"/>' +
				'<finishParticleSize value="8.540000000000001"/>' +
