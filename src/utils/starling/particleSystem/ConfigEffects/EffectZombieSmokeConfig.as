...
{
	public class EffectZombieSmokeConfig
	{
		public static const ZOMBIE_SMOKE_CONFIG: String =
		'<particleEmitterConfig>' +
			...
			'<particleLifeSpan value="0.47000000000000003"/>' +
			'<particleLifespanVariance value="0.96"/>' +
			'<angle value="275.37"/>' +
			'<angleVariance value="62.86"/>' +
			...
			'<maxParticles value="15.38"/>' +
			'<startParticleSize value="65.78"/>' +
			'<startParticleSizeVariance value="9.77"/>' +
			'<finishParticleSize value="14.26"/>' +
		...
		public function EffectZombieSmokeConfig()
		{
		}
	}
}