...
{
	public class EffectSquirrelFireConfig
	{
		public static const SQUIRREL_FIRE_CONFIG: String =
		...
		static public const SQUIRREL_FIRE_BLUE_CONFIG:String =
		'<particleEmitterConfig>' +
			'<texture name="texture.png"/>' +
			'<sourcePosition x="300.00" y="300.00"/>' +
			'<sourcePositionVariance x="0" y="0"/>' +
			...
			'<radialAccelVariance value="0"/>' +
			'<tangentialAccelVariance value="0"/>' +
			'<startColor red="0" green="1" blue="1" alpha="0.86"/>' +
			'<startColorVariance red="0" green="0" blue="0" alpha="0"/>' +
			'<finishColor red="0" green="0.21" blue="0.6900000000000001" alpha="0.12"/>' +
			'<finishColorVariance red="0" green="0" blue="0" alpha="0"/>' +
			'<maxParticles value="103.1"/>' +
			'<startParticleSize value="70"/>' +
			'<startParticleSizeVariance value="0"/>' +
		...
		public function EffectSquirrelFireConfig()
		{
		}
	}
}