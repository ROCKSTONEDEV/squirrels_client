package utils.starling.extensions
{
	 ...
	 * @see #utils.starling.extensions.FFParticleSystem()
	...
	public class FFParticleSystem extends DisplayObject implements IAnimatable
	{
		...
		/**
		 * A offset your emitter position.
		 */
