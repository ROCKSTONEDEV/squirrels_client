...
public class Odnoklassniki {
	...
	public final void requestAuthorization(final Context context, final OkTokenRequestListener tokenRequestListener, final boolean oauthOnly) {
		setTokenRequestListener(tokenRequestListener);
	...
	/**
	 * Try and refresh access token asynchronously. Use {@link ru.ok.android.sdk.Odnoklassniki#setTokenRequestListener(OkTokenRequestListener)} method
	 * to setup callback.
	 * <p>
	 ...
	 * @param deviceGroups
	 *            - list of device groups on which the invitation will be shown. Check {@link ru.ok.android.sdk.util.OkDevice} enum for the list of supported device groups (cannot be null).
	 * @return
	 * @throws IOException
	 */
